...
- Andreas added an IIR filter (10-sample average + 30/70 weighted blend) to smooth the temperature readings. It fluctuateded quite a bit due to imprecise ADC on the ESP8266, it is also very affected by the noise from the Wifi-module.
...
- Sigurd made more revisions to CAD and setup more prints