...
\begin{textblock*}{8cm}(8.3cm,13cm)
    \fbox{\includegraphics[width=2.6cm]{images/frontpage/dtu_anders.png}}
\end{textblock*}
...
\begin{textblock*}{8cm}(14.1cm,13cm)
    \fbox{\includegraphics[width=2.6cm]{images/frontpage/dtu_tobias.png}}
\end{textblock*}
...
\newpage
\appendix
\input{sections/appendix-who-did-what}
