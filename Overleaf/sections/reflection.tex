...
\begin{itemize}
    ...
    \item \textbf{Not enough torque to close the bag.} A single stepper motor could not pull the bag's strings tight enough to close it. We added a second motor so the two together provide enough force to reel the strings in fully.
