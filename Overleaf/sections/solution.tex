...
Our solution is a cloud connected trash bin that closes its own bag and reports its status to a phone-friendly web dashboard. Internally the system has four parts that never talk to each other directly:
